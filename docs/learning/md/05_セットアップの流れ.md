...
<div style="margin-bottom: 24px;">
  <div style="background: #3b82f6; color: white; padding: 8px 16px; border-radius: 6px 6px 0 0; font-weight: bold; display: inline-block;">事前準備</div>
  <div style="display: flex; align-items: center; gap: 12px; flex-wrap: wrap; padding: 16px; background: #eff6ff; border-radius: 0 6px 6px 6px; border: 2px solid #3b82f6;">
    <div style="background: white; border: 2px solid #3b82f6; border-radius: 8px; padding: 12px 20px; text-align: center; min-width: 120px;">
      <div style="font-size: 0.8em; color: #6b7280;">STEP 1</div>
      <div style="font-weight: bold; color: #1e40af;">GCP<br>プロジェクト作成</div>
    </div>
    <div style="color: #3b82f6; font-size: 1.5em;">→</div>
    <div style="background: white; border: 2px solid #3b82f6; border-radius: 8px; padding: 12px 20px; text-align: center; min-width: 120px;">
      <div style="font-size: 0.8em; color: #6b7280;">STEP 2</div>
      <div style="font-weight: bold; color: #1e40af;">Firebase<br>設定</div>
    </div>
    <div style="color: #3b82f6; font-size: 1.5em;">→</div>
    <div style="background: white; border: 2px solid #3b82f6; border-radius: 8px; padding: 12px 20px; text-align: center; min-width: 120px;">
      <div style="font-size: 0.8em; color: #6b7280;">STEP 3</div>
      <div style="font-weight: bold; color: #1e40af;">サービス<br>アカウント作成</div>
    </div>
  </div>
</div>
...
<!-- 環境変数設定 -->
<div style="margin-bottom: 24px;">
  <div style="background: #10b981; color: white; padding: 8px 16px; border-radius: 6px 6px 0 0; font-weight: bold; display: inline-block;">環境変数設定</div>
  <div style="display: flex; align-items: center; gap: 12px; flex-wrap: wrap; padding: 16px; background: #ecfdf5; border-radius: 0 6px 6px 6px; border: 2px solid #10b981;">
    <div style="background: white; border: 2px solid #10b981; border-radius: 8px; padding: 12px 20px; text-align: center; min-width: 140px;">
      <div style="font-size: 0.8em; color: #6b7280;">STEP 4</div>
      <div style="font-weight: bold; color: #065f46;">backend/.env</div>
    </div>
    <div style="background: white; border: 2px solid #10b981; border-radius: 8px; padding: 12px 20px; text-align: center; min-width: 140px;">
      <div style="font-size: 0.8em; color: #6b7280;">STEP 5</div>
      <div style="font-weight: bold; color: #065f46;">frontend/.env</div>
    </div>
  </div>
</div>
...
<!-- 依存関係インストール -->
<div style="margin-bottom: 24px;">
  <div style="background: #8b5cf6; color: white; padding: 8px 16px; border-radius: 6px 6px 0 0; font-weight: bold; display: inline-block;">依存関係インストール</div>
  <div style="display: flex; align-items: center; gap: 12px; flex-wrap: wrap; padding: 16px; background: #f5f3ff; border-radius: 0 6px 6px 6px; border: 2px solid #8b5cf6;">
    <div style="background: white; border: 2px solid #8b5cf6; border-radius: 8px; padding: 12px 20px; text-align: center; min-width: 140px;">
      <div style="font-size: 0.8em; color: #6b7280;">STEP 6</div>
      <div style="font-weight: bold; color: #5b21b6;">pip install</div>
      <div style="font-size: 0.75em; color: #6b7280;">（Python）</div>
    </div>
    <div style="background: white; border: 2px solid #8b5cf6; border-radius: 8px; padding: 12px 20px; text-align: center; min-width: 140px;">
      <div style="font-size: 0.8em; color: #6b7280;">STEP 7</div>
      <div style="font-weight: bold; color: #5b21b6;">npm install</div>
      <div style="font-size: 0.75em; color: #6b7280;">（JavaScript）</div>
    </div>
  </div>
</div>
...
<!-- 初期データ設定 -->
<div style="margin-bottom: 24px;">
  <div style="background: #f59e0b; color: white; padding: 8px 16px; border-radius: 6px 6px 0 0; font-weight: bold; display: inline-block;">初期データ設定</div>
  <div style="display: flex; align-items: center; gap: 12px; flex-wrap: wrap; padding: 16px; background: #fffbeb; border-radius: 0 6px 6px 6px; border: 2px solid #f59e0b;">
    <div style="background: white; border: 2px solid #f59e0b; border-radius: 8px; padding: 12px 20px; text-align: center; min-width: 120px;">
      <div style="font-size: 0.8em; color: #6b7280;">STEP 8</div>
      <div style="font-weight: bold; color: #b45309;">顧客を追加</div>
    </div>
    <div style="color: #f59e0b; font-size: 1.5em;">→</div>
    <div style="background: white; border: 2px solid #f59e0b; border-radius: 8px; padding: 12px 20px; text-align: center; min-width: 120px;">
      <div style="font-size: 0.8em; color: #6b7280;">STEP 9</div>
      <div style="font-weight: bold; color: #b45309;">ドメイン登録</div>
    </div>
  </div>
</div>
...
<div style="margin-bottom: 8px;">
  <div style="background: #ef4444; color: white; padding: 8px 16px; border-radius: 6px 6px 0 0; font-weight: bold; display: inline-block;">起動</div>
  <div style="display: flex; align-items: center; gap: 12px; flex-wrap: wrap; padding: 16px; background: #fef2f2; border-radius: 0 6px 6px 6px; border: 2px solid #ef4444;">
    <div style="background: white; border: 2px solid #ef4444; border-radius: 8px; padding: 12px 20px; text-align: center; min-width: 120px;">
      <div style="font-size: 0.8em; color: #6b7280;">STEP 10</div>
      <div style="font-weight: bold; color: #b91c1c;">バックエンド<br>起動</div>
    </div>
    <div style="color: #ef4444; font-size: 1.5em;">→</div>
    <div style="background: white; border: 2px solid #ef4444; border-radius: 8px; padding: 12px 20px; text-align: center; min-width: 120px;">
      <div style="font-size: 0.8em; color: #6b7280;">STEP 11</div>
      <div style="font-weight: bold; color: #b91c1c;">フロントエンド<br>起動</div>
    </div>
    <div style="color: #ef4444; font-size: 1.5em;">→</div>
    <div style="background: #ef4444; border: 2px solid #ef4444; border-radius: 8px; padding: 12px 20px; text-align: center; min-width: 120px;">
      <div style="font-size: 0.8em; color: #fecaca;">STEP 12</div>
      <div style="font-weight: bold; color: white;">🎉 動作確認</div>
    </div>
  </div>
</div>
...
### package.json と node_modules の関係
...
3. 「コレクションを開始」をクリック
4. コレクションID: `customers` と入力
5. ドキュメントID: `test-corp` と入力
6. 以下のフィールドを追加:
...
| `allowed_domains` | array | （次のステップで追加） |
| `allowed_emails` | array | （次のステップで追加） |
| `cloud_functions_url` | string | http://localhost:8080 |
...
### 推奨：自動振り分けを使う（Firebase Console）

1. Firebase Console → **Firestore Database**
2. `customers` → `test-corp` ドキュメントを開く
3. `allowed_domains` フィールドを編集:
   - 「配列に追加」をクリック
   - 値: `test-corp.co.jp`（@は不要）
4. 「更新」をクリック

**→ これで @test-corp.co.jp のユーザーは全員自動で振り分けられます！**
...
1. Firebase Console → **Firestore Database**
2. `customers` → `test-corp` ドキュメントを開く
3. `allowed_emails` フィールドを編集:
   - 「配列に追加」をクリック
   - 値: `your-email@gmail.com`
4. 「更新」をクリック

<div class="tip-box">
<h3>✨ 自動振り分けの仕組み</h3>
<p><strong>【従来の方法】400人の会社を登録する場合</strong><br>
→ 400人分のメールを1つずつ登録... 大変！</p>
<p><strong>【自動振り分け】</strong><br>
→ `allowed_domains` にドメインを1つ追加するだけ！<br>
→ @acme.co.jp のユーザーは全員自動で振り分け</p>
<p><strong>メモ:</strong> ここでいう「ドメイン」は、メールアドレスの@以降の部分（メールドメイン）です。URLドメインではありません。</p>
<table>
<tr><th>方法</th><th>Firestoreフィールド</th><th>用途</th></tr>
<tr><td>メールドメイン登録</td><td>allowed_domains</td><td>社員全員を一括登録（@acme.co.jpなど）</td></tr>
<tr><td>個別メール登録</td><td>allowed_emails</td><td>業務委託者を個別登録（外部メール）</td></tr>
</table>
</div>
...
原因: 自動振り分けにマッチしない<br>
対処: Firebase Console → Firestore → customers → test-corp → allowed_emails にメールを追加</p>

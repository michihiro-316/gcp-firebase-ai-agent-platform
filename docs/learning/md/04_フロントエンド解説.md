...
**`error: authError`** は「`error` を取り出して `authError` という別名で使う」という意味です。

**Pythonで書くと:**
```python
# Pythonの辞書から値を取り出すイメージ
...
**JavaScriptの分割代入は、これを1行で書ける便利な書き方です！**

...
<tr><td><code>UseChatOptions</code></td><td>useChat に渡す引数の型</td><td>useChat 関数の引数</td></tr>
</table>
...
<h4>似た名前の区別</h4>
<table>
<tr><th>名前</th><th>これは何？</th></tr>
<tr><td><code>Message</code></td><td><strong>型</strong>（interface）。メッセージの構造を定義</td></tr>
<tr><td><code>messages</code></td><td><strong>変数</strong>（配列）。実際のメッセージデータ</td></tr>
<tr><td><code>userMessage</code></td><td><strong>変数</strong>（1つ）。ユーザーが送ったメッセージ</td></tr>
<tr><td><code>assistantMessage</code></td><td><strong>変数</strong>（1つ）。AIの返答メッセージ</td></tr>
<tr><td><code>sendMessage</code></td><td><strong>関数</strong>。メッセージを送信する処理</td></tr>
<tr><td><code>sendChatMessage</code></td><td><strong>関数（api.ts）</strong>。バックエンドにHTTPリクエスト</td></tr>
</table>

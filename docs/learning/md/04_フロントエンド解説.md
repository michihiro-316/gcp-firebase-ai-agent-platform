...
<table style="width: 100%; border-collapse: collapse; background: #1e1e1e; color: #fff; font-family: monospace;">
<tr>
<td colspan="2" style="padding: 8px; border: 1px solid #444; background: #2d2d2d;">localStorage</td>
</tr>
<tr>
<th style="padding: 8px; border: 1px solid #444; background: #333; width: 30%;">キー</th>
<th style="padding: 8px; border: 1px solid #444; background: #333;">値</th>
</tr>
<tr>
<td style="padding: 8px; border: 1px solid #444;"><code>chat_sessions</code></td>
<td style="padding: 8px; border: 1px solid #444;"><code>[{"id":"session_123", "title":"天気について", "messages":[...]}, {...}]</code></td>
</tr>
</table>

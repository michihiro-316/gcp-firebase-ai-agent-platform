...
## 1. Gateway (gateway/main.py) - すべてのリクエストの入口
...
<tr><td><code>gateway/main.py</code></td><td>手動実装</td><td>プリフライトリクエスト対応</td></tr>
<tr><td><code>backend/common/cors.py</code></td><td>flask-cors</td><td>シンプルなCORS設定</td></tr>
</table>

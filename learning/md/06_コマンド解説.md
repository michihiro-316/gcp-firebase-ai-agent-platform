...
**backend/scripts/manage_customer.py** を使います。
...
| `add-domain` | ドメインを追加 | `python scripts/manage_customer.py add-domain acme-corp acme.co.jp` |
...
| 手動紐付け | `add-user` | 自動振り分けを使わない特殊ケース |
